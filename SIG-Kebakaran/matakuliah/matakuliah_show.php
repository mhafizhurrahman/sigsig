    ...
    <div class="card-body">
        <form action="?page=matakuliah-show" method="POST">
            <div class=" input-group mb-3">
                <input type="text" class="form-control" placeholder="Masukan Nama Matakuliah..." name="keyword">
            ...
            <table class="table table-sm table-bordered table-hover m-0">
                ...
                <tbody>
                    ...
                    if (isset($_POST['search'])) {
                        ...
                        if (!empty($keyword)) {
                            $query = mysqli_query($con, "SELECT * FROM matakuliah WHERE id LIKE '%" . $keyword . "%' OR nama LIKE '%" .
                                $keyword . "%'");
                        }
                    }
                    $no = $mulai + 1;
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-sm btn-success" href="?page=matakuliah-edit&id=<?php echo $data['id']; ?>">Edit</a><!-- ini edit -->
                                <a class="btn btn-sm btn-danger" href="../matakuliah/matakuliah_delete.php?id=<?php echo $data['id']; ?>" onclick="return confirm('Anda yakin mau menghapus item ini ?')">Hapus</a><!-- ini hapus -->
                            </td>
                        </tr>
                    <?php
                        $no++;
